...
namespace SuperShop {
    ...
    public partial class taskDataSet : global::System.Data.DataSet {
        ...
        public partial class userloginDataTable : global::System.Data.TypedTableBase<userloginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public userloginRow AdduserloginRow(string id, string username, string password, string usertype) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public userloginRow FindByid(string id) {
        ...
        public partial class userloginRow : global::System.Data.DataRow {
            ...
            public string id {
                get {
                    return ((string)(this[this.tableuserlogin.idColumn]));
                }
                set {
...
namespace SuperShop.taskDataSetTableAdapters {
    ...
    public partial class userloginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[userlogin] ([id], [username], [password], [usertype]) VALUES (" +
                "@id, @username, @password, @usertype);\r\nSELECT id, username, password, usertype " +
                "FROM userlogin WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[userlogin] SET [id] = @id, [username] = @username, [password] = @password, [usertype] = @usertype WHERE (([id] = @Original_id) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_usertype = 1 AND [usertype] IS NULL) OR ([usertype] = @Original_usertype)));
SELECT id, username, password, usertype FROM userlogin WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SuperShop.Properties.Settings.Default.taskConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, username, password, usertype FROM dbo.userlogin";
        ...
        public virtual int Fill(taskDataSet.userloginDataTable dataTable) {
        ...
        public virtual taskDataSet.userloginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            taskDataSet.userloginDataTable dataTable = new taskDataSet.userloginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(taskDataSet.userloginDataTable dataTable) {
        ...
        public virtual int Delete(string Original_id, string Original_username, string Original_password, string Original_usertype) {
            if ((Original_id == null)) {
        ...
        public virtual int Insert(string id, string username, string password, string usertype) {
            if ((id == null)) {
        ...
        public virtual int Update(string id, string username, string password, string usertype, string Original_id, string Original_username, string Original_password, string Original_usertype) {
            if ((id == null)) {
                throw new global::System.ArgumentNullException("id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, string usertype, string Original_id, string Original_username, string Original_password, string Original_usertype) {
